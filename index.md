...
My work lives at the intersection of **distributed systems**, **network infrastructure**, and **security**. Whether I'm designing a fault-tolerant voting platform that survives node failures mid-election, or conducting a full EBIOS-RM risk assessment across five workshops for a real enterprise, I care deeply about systems that are resilient, secure, and built to last.
...
**Security**
- Risk analysis with EBIOS-RM (ANSSI methodology)
- ISO/IEC 27001, ISSP design, BCP/DRP planning
- End-to-end encryption (AES, RSA-2048, PGP concepts, SHA-256)
- Access control (RBAC, MFA), introductory penetration testing & reconnaissance
...
**[GitHub →](https://github.com/Mothrxa/__Distributed-Voting__)**

| | |
|---|---|
| **Tech Stack** | React + Vite, Nginx, Node.js, Express, PostgreSQL, Patroni, etcd, HAProxy, Tailscale VPN |
| **Infrastructure** | 12 VMs on VirtualBox |
| **Domain** | Systems & Network Administration · Distributed Systems |

A secure, production-grade voting platform built on a true three-tier distributed architecture — 12 virtual machines, zero single points of failure. Each tier (frontend, backend, database) runs behind its own HAProxy load balancer, with three nodes per tier operating independently so failures never cascade.
...
| | |
|---|---|
| **Tech Stack** | Flutter Web, Dart, JavaScript, AES/CBC, RSA-2048, SHA-256, Supabase |
...
### Custom Compiler
**[GitHub →](https://github.com/Mothrxa/__Compiler__)**

| | |
|---|---|
| **Tech Stack** | Python, MIPS R3000 assembly |
...
| | |
|---|---|
| **Tech Stack** | Web stack, UML modeling |
| **Domain** | Software Engineering |

A full web-based system for managing patients, appointments, and clinical staff. Requirements modeled with UML (use case, sequence, and class diagrams). Includes authentication and role-based access control. Delivered as a complete software engineering project from specification to implementation.
